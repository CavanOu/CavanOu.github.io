 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa = React$1, ba = scheduler.exports;
function p$1(a) {
...
const Picker$1 = memo(forwardRef((p2, ref) => {
  ...
  const popupElement = React$1.createElement(Popup, {
    ...
    forceRender: true,
    stopPropagation: props.stopPropagation
  }, shouldRender && pickerElement, React$1.createElement(SafeArea, {
    position: "bottom"
  }));
...
function createErrorBlock(imageRecord2) {
  const ErrorBlock2 = (p2) => {
    ...
    const imageNode = typeof image2 === "string" ? React$1.createElement("img", {
      src: image2,
...
const SearchBar = forwardRef((p2, ref) => {
  const {
    locale
  } = useConfig();
...
const SwipeAction = forwardRef((p2, ref) => {
  const props = mergeProps(defaultProps$a, p2);
  const rootRef = useRef(null);
...
const Swiper = forwardRef(staged((p2, ref) => {
...
const TextArea = forwardRef((p2, ref) => {
...
const VirtualInput = forwardRef((p2, ref) => {
